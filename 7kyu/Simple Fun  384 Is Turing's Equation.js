...
Task
You are given a string s. It's an equation such as "a+b=c", where a, b, c are numbers made up of the digits 0 to 9. 
...
function isTuringEquation(s){
    let firstNum = s.split('+')[0].split('').reverse().join('')*1
    let secondNum = s.split('+')[1].split('=')[0].split('').reverse().join('')*1
    let result = s.split('+')[1].split('=')[1].split('').reverse().join('')*1
